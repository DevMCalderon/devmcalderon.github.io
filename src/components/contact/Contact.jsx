      ...
      >
        <div className='lg:max-w-screen-2xl mx-auto w-full h-full flex flex-wrap items-center'>
          ...
          <section className="mb-[-12rem] w-full mx-auto">
            <div className="bg-container_color3 py-4 md:py-8 px-8 md:px-24 rounded-full w-fit mx-auto">
              <p className="text-xl md:text-2xl text-blue-950 font-bold text-center w-full">{t(`contact.thanks_for_visiting`)}</p>
            </div>
          </section>
        </div>
      </div>
